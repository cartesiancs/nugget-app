...
const renderUtil = {
    ...
    convertMillisecondToHMS: async (ms) => {
...
const renderFilter = {
    addFilterMedia: async (object) => {
        ...
        if (checkDynamicCondition) {
            ...
            let trimStartHMS = await renderUtil.convertMillisecondToHMS(object.element.trim.startTime/1000)
            let trimDurationHMS = await renderUtil.convertMillisecondToHMS((object.element.trim.endTime - object.element.trim.startTime)/1000)
        ...
        if (isExistAudio == true) {
            ...
            //       'end': object.element.trim.endTime/1000
            //     },
            //     'inputs': `[${elementCounts.video}:a]`,
            //     'outputs': `audio`
            // })
